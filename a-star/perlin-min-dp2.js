...
const c1r5 = 0.90;
			...
			let toHerex2 = 100*w/_output.width +wO;
			let toHerey2 = 100*h/_output.height+hO;
...
if(1) {		
			...
			const hx = ( del2 < 50 )?-toHerex2/del2 : Math.sin((here)*2*Math.PI);
			const hy = ( del2 < 50 )?-toHerey2/del2 : Math.cos((here)*2*Math.PI);
