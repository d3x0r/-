...
console.trace( "Hello from AuthSecondary startup script" );
...
io.firewall.addProtocol( "Auth", (ws)=>{
	ws.on( "open", (ws)=>{
		console.log( "received new connection on Auth Primary" );
	} );
	ws.on( "message", (_msg)=>{ 
